              ...
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={chartData} onClick={handleClick} className="cursor-pointer">
                  ...
                  <YAxis 
                    ...
                    ticks={[0, 3, 5, 7, 10]}
                  />
                  <ReferenceLine y={7} stroke="#10b981" strokeDasharray="5 5" opacity={0.3} label={{ value: "Positive", position: "right", fill: "#10b981", fontSize: 10 }} />
                  <ReferenceLine y={3} stroke="#ef4444" strokeDasharray="5 5" opacity={0.3} label={{ value: "Negative", position: "right", fill: "#ef4444", fontSize: 10 }} />
                  <Tooltip 
                  ...
                  <Line
                    ...
                    activeDot={{ r: 7, fill: "#1d4ed8", stroke: "#ffffff", strokeWidth: 2, cursor: 'pointer' }}
                    name="Recruiter"
                    connectNulls
                  />
                  <Line
                    ...
                    activeDot={{ r: 7, fill: "#059669", stroke: "#ffffff", strokeWidth: 2, cursor: 'pointer' }}
                    name="Candidate"
                    connectNulls
                  />
                </LineChart>
